...
<div class="px-6 py-4">
    ...
    <form onSubmit = {handleSubmit}>
        <div class="w-full mt-4">
            <input class="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-500 bg-white border rounded-lg dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 focus:border-indigo-400 dark:focus:border-indigo-300 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-indigo-300" 
            type="text"
            id="username"
...
<div class="flex items-center justify-center py-4 text-center bg-gray-50 dark:bg-gray-700">
    ...
    <Link to="/register" class="mx-2 text-sm font-bold text-indigo-500 dark:text-indigo-400 hover:underline">Register</Link>
</div>
</div>
</section>
  );
